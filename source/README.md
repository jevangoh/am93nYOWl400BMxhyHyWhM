...
gh repo create
```
Then, generate an id using [r0tf0lOBqF6UZ2HxarUT3O](https://github.com/jevangoh/r0tf0lOBqF6UZ2HxarUT3O.git) package and use it as the name of the repository.
Follow through the prompts and after the repository is created, clone it into your local computer by running
```bash
git clone
```
